...
urlpatterns = [
    ...
    url(r'^budget/(?P<budget_id>\d+)/(?P<year>\d{4})/$', views.budget_year_stats_detail, name='budget_year_stats_detail'),
    url(r'^budget/(?P<budget_id>\d+)/(?P<year>\d{4})/(?P<month>\d{2})/$', views.budget_month_stats_detail,
        name='budget_month_stats_detail'),
    url(r'budget/(?P<budget_id>\d+)/(?P<year>\d{4})/(?P<month>\d{2})/(?P<day>\d{2})/$',
    ...
    url(r'test_view/(?P<category_id>\d+)/(?P<year>\d+)/(?P<month>\d+)/$', views.test_view, name='test_view'),
]